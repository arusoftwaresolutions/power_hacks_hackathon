...
export default function RegisterPage() {
  ...
  return (
    <section className="mx-auto max-w-md space-y-6">
      <h1 className="text-2xl font-semibold text-brand-50">Join HerSafeSpace</h1>
      <p className="text-sm text-brand-200">
        Create a free account to ask questions, share your journey and learn how to stay safe online.
      </p>
